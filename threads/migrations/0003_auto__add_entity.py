...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entity'
        db.create_table('threads_entity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_user', to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_group', to=orm['threads.Group'])),
        ))
        db.send_create_signal('threads', ['Entity'])


    def backwards(self, orm):
        # Deleting model 'Entity'
        db.delete_table('threads_entity')
