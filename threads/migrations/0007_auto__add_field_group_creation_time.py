...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.creation_time'
        db.add_column('threads_group', 'creation_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.creation_time'
        db.delete_column('threads_group', 'creation_time')
    ...
    models = {
        ...
        'threads.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'group_location'", 'null': 'True', 'to': "orm['common.Location']"}),
