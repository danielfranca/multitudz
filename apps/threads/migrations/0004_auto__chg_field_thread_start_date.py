...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thread.start_date'
        db.alter_column('threads_thread', 'start_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Thread.start_date'
        db.alter_column('threads_thread', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
